...
parser.add_argument('--azim', default=0, type=int)
parser.add_argument('--elev', default=0, type=int)
...
out_point_path_norm = os.path.join(out_dir, site_name+'_xyz_rgb_{}_norm_1car_{}_rot_{}_{}.pcd'.format(sample_ratio,car_sample_ratio,azim,elev))
...
out_car_path_norm = os.path.join(out_dir, '{}_{}_rot.pcd'.format(car_name, car_sample_ratio))
...
car_sample_rot = np.transpose(np.matmul(R, np.transpose(car_sample_points)))
...
with open(out_point_path_norm, 'w') as of:
    ...
    of.write('TYPE F F F F\r\n')
    of.write('COUNT 1 1 1 1\r\n')
    of.write('WIDTH {}\r\n'.format(len(sample_points)+car_sample_rot.shape[0]))
    of.write('HEIGHT 1\r\n')
    of.write('VIEWPOINT 0 0 0 1 0 0 0\r\n')
    of.write('POINTS {}\r\n'.format(len(sample_points)+car_sample_rot.shape[0]))
    of.write('DATA ascii\r\n')
